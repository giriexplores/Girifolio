...
function NavBar({ heroRef, aboutRef, skillsRef, contactRef, navHandler }) {
  ...
  return (
    <div className="sticky top-0 flex justify-end items-center mx-auto p-2 md:py-4 text-white flex-col gap-4 md:flex-row md:justify-end md:gap-x-20 w-full md:px-20 shadow-xl min-h-[5rem] z-10 bg-[#010f0a] group">
      <div
      ...
      <div
        className="flex items-center justify-center gap-8 md:gap-20 flex-col md:flex md:flex-row absolute md:static top-full p-4 md:p-0 transition-all shadow-xl md:shadow-none bg-[#010f0a] rounded-3xl rounded-se-none md:rounded-none 
        group-focus-within:right-0 -right-full"
      >
      ...
      <button className="absolute top-7 right-4 flex-col gap-2 border-none outline-none flex md:hidden active:scale-95">
